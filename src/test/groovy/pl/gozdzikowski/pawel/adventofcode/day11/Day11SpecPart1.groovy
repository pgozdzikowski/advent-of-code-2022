...
import static MonkeyInTheMiddlePart1.*

class Day11SpecPart1 extends Specification {
    ...
    def 'should simulate and find product of multiply of most active monkeys'() {
        given:
        MonkeyInTheMiddlePart1 monkeyInTheMiddle = new MonkeyInTheMiddlePart1(config);
        expect:
